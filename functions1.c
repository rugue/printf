...
/**
 * print_unsigned - This helps prints an unsigned number
...
/**
 * print_octal - To help print an unsigned numb in octal notation
...
/**
 * print_hexa_upper - To print unsigned numb in upper hexadecimal notation
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
 ...
 * @flag_ch: To help Calculates active flags
 * @width: To get width
 * @precision: The Precision specification
 * @size: The Size specifier
